...
class task3:
    ...
    def __init__(self):
        ...
        rospy.init_node('test_task3', anonymous=True)
...
def main():
    ...
    try:
		...
		red_bin_joint_angles= [math.radians(60),
                             math.radians(-52),
                             math.radians(70),
                             math.radians(-107),
                             math.radians(-91),
		...
		while len(pkg3)==0:
			t3.conveyor_belt_control(70)
		#when packagen1 is in visible range of logical camera
		while pkg3[1] > 0.08000:
			t3.conveyor_belt_control(70)
		t3.conveyor_belt_control(0)
		t3.add_box(-0.900779,-0.022788,0.995000)
		t3.set_joint_angles(blue_box_joint_angles)
		t3.vacuum_on_off(True)
		t3.attach_box()
